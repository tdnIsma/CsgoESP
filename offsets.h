...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4DC177C;
	constexpr ptrdiff_t dwForceAttack = 0x31F1C94;
	constexpr ptrdiff_t dwForceAttack2 = 0x31F1CA0;
	constexpr ptrdiff_t dwForceBackward = 0x31F1CDC;
	constexpr ptrdiff_t dwForceForward = 0x31F1CE8;
	constexpr ptrdiff_t dwForceJump = 0x526B590;
	constexpr ptrdiff_t dwForceLeft = 0x31F1D00;
	constexpr ptrdiff_t dwForceRight = 0x31F1CF4;
	constexpr ptrdiff_t dwGameDir = 0x628700;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52DE86C;
	constexpr ptrdiff_t dwGetAllClasses = 0xDCFAB4;
	constexpr ptrdiff_t dwGlobalVars = 0x589CD0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x5309C78;
	constexpr ptrdiff_t dwInput = 0x5212D40;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x9578B4;
	constexpr ptrdiff_t dwLocalPlayer = 0xDA747C;
	constexpr ptrdiff_t dwMouseEnable = 0xDACFC8;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xDACF98;
	constexpr ptrdiff_t dwPlayerResource = 0x31F0020;
	constexpr ptrdiff_t dwRadarBase = 0x51F64F4;
	constexpr ptrdiff_t dwSensitivity = 0xDACE64;
	constexpr ptrdiff_t dwSensitivityPtr = 0xDACE38;
	constexpr ptrdiff_t dwSetClanTag = 0x8A290;
	constexpr ptrdiff_t dwViewMatrix = 0x4DB3094;
	constexpr ptrdiff_t dwWeaponTable = 0x5213804;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
	constexpr ptrdiff_t dwYawPtr = 0xDACC28;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDB1EC8;
	...
	constexpr ptrdiff_t m_yawClassPtr = 0xDACC28;
	constexpr ptrdiff_t m_pitchClassPtr = 0x51F6790;
	...
	constexpr ptrdiff_t find_hud_element = 0x53E33080;
